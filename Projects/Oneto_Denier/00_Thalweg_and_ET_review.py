...
# Goal: plot groundwater level against nearest stream thalweg
...
def mw_plt(gwl_long, mw, ax_n):
    ...
    ax_n.grid(axis='y', alpha=0.8)
    ax_n.grid(visible=True, axis='y', which='minor', alpha=0.3, )
    # ax_n.set_title(mw[n])
