...
# %%
join(m_model_ws, 'model_metadata.txt')
...
well_loc_merge[['UniqueID','dem','layer', 'row','column']].to_csv(join(model_ws, 'crop_modflow', 'parcel_wells_with_layer.csv'), index=False)
