...
folder= 'Cosumnes/output_8/';%'Switzerland/output_8/'
dt='1d';
IDair= '131'; %'SIO'
IDwat= 'MHB'; %'2011'
index='RMS';
...
% nanmean didn't work, trying mean instead
RMSE_cal=sqrt(mean((T_cal(:,5)-T_cal(:,6)).^2));
RMSE_val=sqrt(mean((T_val(:,5)-T_val(:,6)).^2));
